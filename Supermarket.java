...
public class Supermarket {
    ...
    public static void main(String[] args) {
        ...
        String correctCaptcha = "ABCD123"; // Captcha tetap untuk contoh
        ...
        do {
            ...
            if (username.equals("ami") && password.equals("12345") && inputCaptcha.equals(correctCaptcha)) {
        ...
        // Proses Transaksi
        System.out.println("\n+---------------------------------------------+");
        System.out.println("Selamat Datang di Supermarket AmiMart");
        System.out.println("+---------------------------------------------+");
        ...
        System.out.println("+---------------------------------------------+");
        System.out.println("Terima kasih telah berbelanja di AmiMart");
        System.out.println("+---------------------------------------------+");
